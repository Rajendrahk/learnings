One small clarification before continuing.

**Vector Stores** were already covered in the previous section (**3.4 – RAG Foundation**), alongside Documents, Embeddings, and Retrievers.

So the remaining topics for **Core Concepts** are:
