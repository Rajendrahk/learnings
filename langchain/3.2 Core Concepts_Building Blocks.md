Excellent. This is the point where LangChain starts to become much more powerful. Up to now, we've learned how to **talk to an LLM**. Now we'll learn how to **build AI applications** by composing components together.
